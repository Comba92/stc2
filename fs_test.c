...
int main() {
  ...
  printf("%d\n", file_exists("./fs_test/test.txt"));
  printf("%d\n", file_exists("./faggot_killer.txt"));
  printf("%d\n", dir_exists(".."));
  printf("%d\n", dir_exists("../stc"));
  printf("%d\n", dir_exists("../urmom"));

  dir_create("./fs_test/test1");
  printf("Delete ok: %d\n", dir_delete("./fs_test/test1"));
  ...
  file_create("./fs_test/test.txt", false);
  printf("Copy base: %d\n", file_copy("./fs_test/test.txt", "./fs_test/test2.txt", false));
  printf("Copy overwrite: %d\n", file_copy("./fs_test/test.txt", "./fs_test/test2.txt", true));
  printf("Copy no overwrite: %d\n", file_copy("./fs_test/test.txt", "./fs_test/test2.txt", false));
  printf("Delete: %d\n", file_delete("./fs_test/test.txt"));
  file_create("./fs_test/test.txt", false);
  printf("Move base: %d\n", file_move("./fs_test/test.txt", "./fs_test/test3.txt", false));
  file_create("./fs_test/test.txt", false);
  printf("Move overwrite: %d\n", file_move("./fs_test/test.txt", "./fs_test/test3.txt", true));
  file_create("./fs_test/test.txt", false);
  printf("Move no overwrite: %d\n", file_move("./fs_test/test.txt", "./fs_test/test3.txt", false));
  printf("Create overwrite: %d\n", file_create("./fs_test/test3.txt", true));
  printf("Create no overwrite: %d\n", file_create("./fs_test/test3.txt", false));
  ...
  dir_create("./fs_test/test3/dasdas/reiorew/fdsjporetjw");
  dir_create_recursive("./fs_test/test3/dasdas/reiorew/fdsjporetjw");
  printf("test3 dir created\n");
  dir_delete_recursive("./fs_test/test3/");
  dir_delete_recursive("./test3/");
  printf("test3 dir deleted\n");

  printf("test5 dir created\n");
  dir_create_recursive("./fs_test/test5/daaaaa/dsadasad/adasdas");
